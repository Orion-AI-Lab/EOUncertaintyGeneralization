...
from datasets.torchgeo_imports.errors import DatasetNotFoundError, RGBBandsMissingError
from datasets.torchgeo_imports.geo import NonGeoClassificationDataset
from datasets.torchgeo_imports.utils import Path, check_integrity, download_url, extract_archive, rasterio_loader
import einops
    ...
    * https://ieeexplore.ieee.org/document/8519248
    ...
    def __getitem__(self, index: int) -> dict[str, Tensor]:
        ...
        if self.transforms is not None:
            image = sample['image']/sample['image'].max()
