...
sentinel2_url=https://zenodo.org/records/10891137/files/BigEarthNet-S2.tar.zst?download=1
sentinel1_url=https://zenodo.org/records/10891137/files/BigEarthNet-S1.tar.zst?download=1
...
wget -O "$full_path/BigEarthNet-S2-v1.0.tar.zst" $sentinel2_url
...
wget -O "$full_path/BigEarthNet-S1-v1.0.tar.zst" $sentinel1_url
...
tar --zstd -xvf "$full_path/BigEarthNet-S2-v1.0.tar.zst" --directory $full_path
...
tar --zstd -xvf "$full_path/BigEarthNet-S1-v1.0.tar.zst" --directory $full_path
...
rm "$full_path/BigEarthNet-S2-v1.0.tar.zst"
rm "$full_path/BigEarthNet-S1-v1.0.tar.zst"
